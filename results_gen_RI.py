...
for i in range(2):
    ...
    for data_file in ['datasets\\ionosphere.txt']:
        print data_file
        f = open(data_file, "r")
        file = open("result\\"+str(i)+"Forest_RI_"+data_file[9:-4]+".txt", "w")
        X = []
        ...
        if data_file=='datasets\\breast_cancer.txt':
            del df[0]
        ...
        for iter in range(NUMBER_ITER):
            ...
            adaboost_error = adaboost_error + 1-adaboost.score(X_test, Y_test)
    ...
    #        plt.show()
        ...
        adaboost_error = adaboost_error / NUMBER_ITER
